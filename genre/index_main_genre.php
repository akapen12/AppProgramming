		...
		<!-- Wrapper -->
			<div id="wrapper">
						...
						<div class="inner">
							...
							<header>
								<div id="area">
									...
									<button type="button" class="navyBtn" onClick="location.href='genre/index_main_genre_action.php'">액션 장르 별 게임</button>
									<button type="button" class="navyBtn" onClick="location.href='genre/index_main_genre_rpg.php'">RPG 장르 별 게임</button>
									<button type="button" class="navyBtn" onClick="location.href='genre/index_main_genre_adventure.php'">어드벤쳐 장르 별 게임</button>
									<button type="button" class="navyBtn" onClick="location.href='genre/index_main_genre_simulation.php'">시뮬레이션 별 게임</button>
									<button type="button" class="navyBtn" onClick="location.href='genre/index_main_genre_indie.php'">인디 장르 별 게임</button>
				...
				<!-- Footer -->
					<footer id="footer">
						<div class="inner">
						<button type="button" class="navyBtn" onClick="location.href='PAGENAME.html'">장르 별 게임</button>
						<button type="button" class="navyBtn" onClick="location.href='PAGENAME.html'">할인 중인 게임 </button>
						<button type="button" class="navyBtn" onClick="location.href='PAGENAME.html'">최근 출시 게임 </button>
						</div>
					</footer>
