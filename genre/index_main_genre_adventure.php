						...
						<div class="inner">
							...
							<header>
								<div id="area">
									...
									<button type="button" class="navyBtn" onClick="location.href='index_main_genre_action.php'">액션 장르 별 게임</button>
									<button type="button" class="navyBtn" onClick="location.href='index_main_genre_rpg.php'">RPG 장르 별 게임</button>
									<button type="button" class="navyBtn" onClick="location.href='index_main_genre_adventure.php'">어드벤처 장르 별 게임</button>
									<button type="button" class="navyBtn" onClick="location.href='index_main_genre_simulation.php'">시뮬레이션 별 게임</button>
									<button type="button" class="navyBtn" onClick="location.href='index_main_genre_indie.php'">인디 장르 별 게임</button>
